...
<td style="padding: 10px; font-size:20px; color:black;">{{$appoints->comment}}</td>
<td style="padding: 10px; font-size:20px; color:black;">{{$appoints->status}}</td>

<td style="padding: 10px; font-size:20px; color:black;"> <a class="bt btn-danger" href="{{url('cancel_appoint', $appoints->id)}}">Cancel </a></td>
</tr>
